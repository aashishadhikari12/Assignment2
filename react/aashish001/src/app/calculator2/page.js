...
import {Button} from "@nextui-org/react";
  const page = () => {
    ...
    return (
      ...
      <div className='bg-gray-700 h-16 text-white text-4xl'>
         {num}
      </div>
      <div className='flex'>
      <div className='flex-col'>
      {generateDigits()}
      <button onClick={()=>setNum('')} className='m-2 w-10 h-10 bg-blue-700 text-2xl text-white text-center rounded-lg'>AC</button>
